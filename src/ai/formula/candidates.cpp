/**
 * @file src/ai/formula/candidates.cpp
 * @project The Battle for Wesnoth NG - https://github.com/justinzane/wesnoth-ng
 * @brief 
 * @authors 
 * @copyright Copyright (C) 2009 - 2013 by Bartosz Waresiak <dragonking@o2.pl>
...
bool candidate_action_mgr::evaluate_candidate_actions(ai::formula_ai* ai, unit_map& units)
{
	...
	foreach_ng(candidate_action_ptr cm, candidate_actions_)
	{
	...
	, filter_map_()
{
	...
	if( filter_params ) {
		foreach_ng( const config::attribute filter_param, filter_params.attribute_range() )
		{
