/**
 * @file src/ai/testing/stage_rca.cpp
...
void candidate_action_evaluation_loop::on_create()
{
	...
	foreach_ng(const config &cfg_element, cfg_.child_range("candidate_action")){
...
config candidate_action_evaluation_loop::to_config() const
{
	...
	foreach_ng(candidate_action_ptr ca, candidate_actions_){
...
bool candidate_action_evaluation_loop::do_play_stage()
{
	...
	do {
		...
		//Evaluation
		foreach_ng(candidate_action_ptr ca_ptr, candidate_actions_){
