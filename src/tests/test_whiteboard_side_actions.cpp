/**
 * @file src/tests/test_whiteboard_side_actions.cpp
 * @project The Battle for Wesnoth NG - https://github.com/justinzane/wesnoth-ng
 * @brief 
 * @authors 
 * @copyright Copyright (C) 2012 - 2013 by Étienne Simon <etienne.jl.simon@gmail.com>
