/**
 * @file src/serdes/wml_exception.cpp
...
std::string deprecated_renamed_wml_key_warning(const std::string& deprecated_key,
    ...
    return vgettext("The key '$deprecated_key' has been renamed to '$key'. "
...
const config::attribute_value& get_renamed_config_attribute(const config& cfg,
    ...
    if (result) {
        lg::wml_error << deprecated_renamed_wml_key_warning(deprecated_key, key,
                                                            removal_version)
        << '\n';
