/**
 * @file src/floating_textbox.cpp
 * @project The Battle for Wesnoth NG - https://github.com/justinzane/wesnoth-ng
 * @brief 
 * @authors 
 * @copyright Copyright (C) 2006 - 2013 by Joerg Hinrichs <joerg.hinrichs@alice-dsl.de>
...
namespace gui{
	...
	void floating_textbox::tab(const std::set<std::string>& dictionary)
	{
		...
		if (matches.size() == 1 && mode_ == gui::TEXTBOX_MESSAGE) {
			...
			resources::screen->add_chat_message(time(nullptr), "", 0, completion_list,
