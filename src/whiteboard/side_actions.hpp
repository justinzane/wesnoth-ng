...
/**
 * @brief Datastructure holding the actions of a side on multiple turns.
        ...
        typedef multi_index::multi_index_container<
            ...
            multi_index::indexed_by<
                multi_index::random_access<
                    multi_index::tag<chronological>
                >,
                multi_index::hashed_non_unique<
                    multi_index::tag<by_unit>,
                    multi_index::const_mem_fun<action, std::string, &action::get_unit_id>
                >,
                multi_index::hashed_non_unique<
                    multi_index::tag<by_hex>,
                    multi_index::const_mem_fun<action, map_location, &action::get_numbering_hex>
                >
            >
        >
        action_set;
 ...
 */
class side_actions: public enable_shared_from_this<side_actions> {
    public:
        ...
        template <typename T, typename Compare>
        const_iterator find_first_action_of(std::pair<T, T> between,
        ...
        const_iterator find_last_action_of(unit const& unit,
                                           const_iterator start_position) const;
         ...
         */
        iterator queue_move(size_t turn_num,
                            unit& mover,
         ...
         */
        iterator queue_attack(size_t turn_num,
                              unit& mover,
         ...
         */
        iterator queue_recruit(size_t turn_num,
         ...
         */
        iterator queue_recall(size_t turn_num,
                              const unit& unit,
...
struct side_actions::numbers_t {
        ...
        numbers_t() :
            numbers_to_draw(), team_numbers(), main_number( -1), secondary_numbers() {
        }
};

template <typename T, typename Compare>
side_actions::iterator side_actions::find_first_action_of(std::pair<T, T> between,
                                                          iterator limit,
                                                          Compare comp) {
...
template <typename T, typename Compare>
side_actions::const_iterator side_actions::find_first_action_of(std::pair<T, T> between,
                                                                const_iterator limit,
                                                                Compare comp) const {
