/**
 * @file 		evt_mgr.cpp is part of wesnoth-ng
...
void evt_mgr::register_hndlr(SDL_EventType type, const evt_handler& hndlr) {
...
void evt_mgr::unregister_hndlr(SDL_EventType type, const evt_handler& hndlr) {
...
bool evt_mgr::is_registered(SDL_EventType type, const evt_handler& hndlr) {
    if (hndlr_map_[type].count(hndlr) == 0) { return false; } else { return true; }
}


void evt_mgr::handle_evt(SDL_Event& evt) {
