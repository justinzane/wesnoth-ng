/**
 * @file 		sdl2_loadscreen_mgr.cpp is part of wesnoth-ng
...
loadscreen_mgr::void reset() {
    if (owns_) {
        owns_ = false;
        instance_ = nullptr;
        assert(loadscreen::global_loadscreen != nullptr);
        loadscreen::global_loadscreen->clear_screen();
        delete loadscreen::global_loadscreen;
        loadscreen::global_loadscreen = nullptr;
    }
}
