 ...
 */
entity_location::entity_location(const map_location &loc, std::string id) :
 ...
 */
entity_location::entity_location(const map_location &loc,
                                 std::string id,
...
entity_location::entity_location(const unit &u) :
    map_location(u.get_location()), id_(u.underlying_id()), filter_loc_( *this) {
}
...
entity_location::entity_location(const unit &u, const map_location & filter_loc) :
    map_location(u.get_location()), id_(u.underlying_id()), filter_loc_(filter_loc) {
}
...
bool entity_location::matches_unit(const unit_map::const_iterator & un_it) const {
    return id_ == "" || (un_it.valid() && id_ == un_it->underlying_id());
}
...
bool entity_location::matches_unit_filter(const unit_map::const_iterator & un_it,
    ...
    return un_it->matches_filter(filter, filter_loc_) && matches_unit(un_it);
}
