/**
 * @file src/widgets/scrollarea.cpp
 * @project The Battle for Wesnoth NG - https://github.com/justinzane/wesnoth-ng
 * @brief 
 * @authors 
 * @copyright Copyright (C) 2004 - 2013 by Guillaume Melquiond <guillaume.melquiond@gmail.com>
...
void scrollarea::handle_event(const SDL_Event& event)
{
	...
	if (is_point_in_rect(e.x, e.y, inner_location())) {
