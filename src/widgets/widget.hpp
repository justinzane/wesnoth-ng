...
class widget : public sdl2_evt_hndlr {
    public:
        ...
        virtual void hide(bool value = true);bool hidden() const;
        virtual void enable(bool new_val = true);bool enabled() const;
        ...
        void set_dirty(bool dirty = true);bool dirty() const;
    ...
    protected:
        ...
        virtual handler_vector member_handlers() {
            return handler::handler_members();
        }
...
//        std::vector<surface_restorer> restorer_;
        ...
        enum {
            UNINIT, HIDDEN, DIRTY, DRAWN
        } state_;bool hidden_override_;bool enabled_;bool clip_;
        SDL_Rect clip_rect_;
