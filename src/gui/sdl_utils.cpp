...
//    typedef std::map<std::string const, SDL_keysym> keysym_map_t;
//    static keysym_map_t keysym_map;
//
//    if ( !initialized) {
//        for (SDL_keysym i = SDLK_FIRST; i < SDLK_LAST; i = SDL_keysym(int(i) + 1)) {
...
surface_restorer::surface_restorer(ui_window* target, const SDL_Rect& rect) :
