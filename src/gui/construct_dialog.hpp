...
class dialog_image: public widget {
    public:
        dialog_image(label * const caption, ui_window &video, surface img) :
...
class filter_textbox: public gui::dialog_textbox {
    public:
        filter_textbox(ui_window& video,
    ...
    private:
        ...
        size_t header_row_;
        gui::dialog& dialog_;
        virtual void handle_text_changed(const std::wstring& text);
};

class dialog_button: public button {
    public:
        dialog_button(ui_window& video,
...
class standard_dialog_button: public dialog_button {
    public:
        standard_dialog_button(ui_window& video,
                               const std::string& label,
                               const int index,
                               const bool is_last) :
