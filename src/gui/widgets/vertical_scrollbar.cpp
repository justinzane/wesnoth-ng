/**
 * @file src/gui/widgets/vertical_scrollbar.cpp
...
bool tvertical_scrollbar::on_positioner(const point_t& coordinate) const
{
...
int tvertical_scrollbar::on_bar(const point_t& coordinate) const
{
