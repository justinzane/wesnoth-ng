 ...
 */
class twidget:
    private boost::noncopyable,     /**< @todo explain why widgets are noncopyable */
    ...
    public:
        ...
        class tvisible:
            ...
            public:
                ...
                enum scoped_enum {
                     ...
                     * - @ref find_at always 'sees' the widget (the active flag is tested later).
                     * - The widget (if active) handles events (and sends events to its children).
                     * - The widget is drawn (and sends the call to @ref populate_dirty_list
                     *   to children). */
                    visible,
        ...
        /**
         * @brief Visibility set by the engine.
         * @details This state only will be used if @ref visible_ is @ref tvisible::visible
        ...
        class tredraw_action:
            ...
            public:
                ...
                /** @todo C++11 use a scoped enum. */
                enum scoped_enum {
                    /** @brief The widget is fully visible and should be drawn if @ref
                     * dirty_ is @c true. The entire widget's rectangle should be redrawn. */
                    full,

                    /** @brief The widget is partly visible and should be drawn if @ref
                     * dirty_ is @c true. The rectangle to redraw in determined by @ref
                     * clipping_rectangle_ */
                    partly,

                    /** @brief The widget is not visible and should not be drawn if
                     * @ref dirty_ is @c true. */
                    none
                };
        };
    ...
    public:
        ...
        twidget() __attribute__((deprecated("Use twidget(const tbuilder_widget& builder).")));
