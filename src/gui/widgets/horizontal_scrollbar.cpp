/**
 * @file src/gui/widgets/horizontal_scrollbar.cpp
...
bool thorizontal_scrollbar::on_positioner(const point_t& coordinate) const
{
...
int thorizontal_scrollbar::on_bar(const point_t& coordinate) const
{
