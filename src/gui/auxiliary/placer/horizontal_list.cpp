/**
 * @file src/gui/auxiliary/placer/horizontal_list.cpp
...
void tplacer_horizontal_list::add_item(const point_t& size) {
...
point_2Dd tplacer_horizontal_list::get_size() const {
...
point_2Dd tplacer_horizontal_list::get_origin(const unsigned index) const {
    ...
    return point_2Dd(columns_[column].first, height);
}
