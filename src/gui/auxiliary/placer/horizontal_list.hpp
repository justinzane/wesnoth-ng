/**
 * @file src/gui/auxiliary/placer/horizontal_list.hpp
...
class tplacer_horizontal_list: public tplacer_ {
    ...
    public:
        ...
        virtual void add_item(const point_t& size);

        virtual point_2Dd get_size() const;

        virtual point_2Dd get_origin(const unsigned index) const;
