/**
 * @file src/gui/auxiliary/event/dispatcher.hpp
 * @project The Battle for Wesnoth NG - https://github.com/justinzane/wesnoth-ng
 * @brief 
 * @authors 
 * @copyright Copyright (C) 2009 - 2013 by Mark de Wever <koraq@xs4all.nl>
...
typedef boost::function<
    void(tdispatcher& dispatcher, const tevent event, bool& handled, bool& halt)> tsignal_function;
 ...
 */
typedef boost::function<
    void(tdispatcher& dispatcher,
         const tevent event,
         bool& handled,
         bool& halt,
         const point_t& coordinate)> tsignal_mouse_function;
 ...
 */
typedef boost::function<
    void(tdispatcher& dispatcher, const tevent event, bool& handled, bool& halt, void*)> tsignal_notification_function;
...
class tdispatcher {
    ...
    public:
         ...
         *                               otherwise.
         */
        virtual bool is_at(const point_t& coordinate) const = 0;

        enum tevent_type {
            pre = 1, child = 2, post = 4
        };
         ...
         */
        bool fire(const tevent event, twidget& target, const point_t& coordinate);
         ...
         */
        template <tevent E>
        typename boost::enable_if<boost::mpl::has_key<tset_event_mouse, boost::mpl::int_<E> > >::type connect_signal(const tsignal_mouse_function& signal,
                                                                                                                     const tposition position =
                                                                                                                         back_child) {
         ...
         */
        template <tevent E>
        typename boost::enable_if<boost::mpl::has_key<tset_event_mouse, boost::mpl::int_<E> > >::type disconnect_signal(const tsignal_mouse_function& signal,
                                                                                                                        const tposition position =
                                                                                                                            back_child) {
         ...
         */
        template <tevent E>
        typename boost::enable_if<boost::mpl::has_key<tset_event_keyboard, boost::mpl::int_<E> > >::type connect_signal(const tsignal_keyboard_function& signal,
                                                                                                                        const tposition position =
                                                                                                                            back_child) {
         ...
         */
        template <tevent E>
        typename boost::enable_if<boost::mpl::has_key<tset_event_keyboard, boost::mpl::int_<E> > >::type disconnect_signal(const tsignal_keyboard_function& signal,
                                                                                                                           const tposition position =
                                                                                                                               back_child) {
        ...
        typename boost::enable_if<
            boost::mpl::has_key<tset_event_notification, boost::mpl::int_<E> > >::type connect_signal(const tsignal_notification_function& signal,
                                                                                                      const tposition position =
                                                                                                          back_child) {
        ...
        template <tevent E>
        typename boost::enable_if<
            boost::mpl::has_key<tset_event_notification, boost::mpl::int_<E> > >::type disconnect_signal(const tsignal_notification_function& signal,
                                                                                                         const tposition position =
                                                                                                             back_child) {
         ...
         */
        template <tevent E>
        typename boost::enable_if<boost::mpl::has_key<tset_event_message, boost::mpl::int_<E> > >::type connect_signal(const tsignal_message_function& signal,
                                                                                                                       const tposition position =
                                                                                                                           back_child) {
         ...
         */
        template <tevent E>
        typename boost::enable_if<boost::mpl::has_key<tset_event_message, boost::mpl::int_<E> > >::type disconnect_signal(const tsignal_message_function& signal,
                                                                                                                          const tposition position =
                                                                                                                              back_child) {
                ...
                void connect_signal(const tevent event,
                    ...
                    switch (position) {
                        case front_pre_child:
                            queue[event].pre_child.insert(queue[event].pre_child.begin(),
                                                          signal);
                            break;
                        case back_pre_child:
                        ...
                        case front_child:
                            queue[event].child.insert(queue[event].child.begin(), signal);
                            break;
                        case back_child:
                        ...
                        case front_post_child:
                            queue[event].post_child.insert(queue[event].post_child.begin(),
                                                           signal);
                            break;
                ...
                void disconnect_signal(const tevent event,
                    ...
                    switch (position) {
                        ...
                        case back_pre_child: {
                            ...
                            for (typename std::vector<T>::iterator itor = signal_queue.child
                                .begin(); itor != signal_queue.child.end(); ++itor) {
 ...
 */
inline void connect_signal_pre_key_press(tdispatcher& dispatcher,
...
inline void connect_signal_notify_modified(tdispatcher& dispatcher,
