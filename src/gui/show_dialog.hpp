...
public:
	...
	dialog_frame(ui_window &video, const std::string& title="",
	...
	SDL_Rect draw_title(ui_window *video);
...
//frame_measurements draw_dialog_frame(int x, int y, int w, int h, ui_window &video, const std::string* dialog_style=NULL, surface_restorer* restorer=NULL);

//SDL_Rect draw_dialog_background(int x, int y, int w, int h, ui_window &video, const std::string& dialog_style);

//given the location of a dialog, will draw its title.
//Returns the area the title takes up
//SDL_Rect draw_dialog_title(int x, int y, ui_window* disp, const std::string& text, label** label_widget);
...
//void draw_dialog(int x, int y, int w, int h, ui_window &video, const std::string& title,
...
//void draw_dialog(frame_measurements &fm, ui_window &video, const std::string& title,
 //                const std::string* dialog_style=NULL, std::vector<button*>* buttons=NULL,
 //                surface_restorer* restorer=NULL, button* help_button=NULL, label** label_widget);
...
public:
	preview_pane(ui_window &video) : widget(video, false) {}
...
void check_quit(ui_window &video);
