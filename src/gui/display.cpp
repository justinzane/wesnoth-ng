...
display::display(unit_map* units, ui_window& video, const gamemap* map, const std::vector<team>* t,const config& theme_cfg, const config& level) :
	units_(units),
...
static void draw_panel(ui_window& video, const theme::panel& panel, std::vector<gui::button>& /*buttons*/)
{
...
static void draw_label(ui_window& video, surface target, const theme::label& label)
{
