...
class unit
{
    public:
        ...
        /** Initializes a unit from a unit type. Only real_unit may have random traits,
         * name and gender(to prevent OOS caused by RNG calls) */
        ...
        const tportrait* portrait(
                                  const unsigned size,
                                  const tportrait::tside side) const;
