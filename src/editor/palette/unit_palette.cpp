/**
 * @file src/editor/palette/unit_palette.cpp
 * @project The Battle for Wesnoth NG - https://github.com/justinzane/wesnoth-ng
 * @brief 
 * @authors 
 * @copyright Copyright (C) 2012 - 2013 by Fabian Mueller <fabianmueller5@gmx.de>
...
void unit_palette::setup(const config& /*cfg*/)
{
	...
	foreach_ng(const race_map::value_type &i, unit_types.races())
	{
		config cfg;
		cfg["id"] = i.second.id();
...
void unit_palette::draw_item(const unit_type& u, SDL_Surface& image, std::stringstream& tooltip_text) {
