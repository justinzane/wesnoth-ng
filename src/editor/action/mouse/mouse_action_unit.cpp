/**
 * @file src/editor/action/mouse/mouse_action_unit.cpp
 * @project The Battle for Wesnoth NG - https://github.com/justinzane/wesnoth-ng
 * @brief 
 * @authors 
 * @copyright Copyright (C) 2008 - 2013 by Fabian Mueller <fabianmueller5@gmx.de>
...
void mouse_action_unit::set_unit_mouse_overlay(editor_display& disp, const unit_type& u)
{
	...
	SDL_Surface image(image::get_image(filename.str()));
	Uint8 alpha = 196;
	//TODO don't hardcode
	int size = 72;
	//int size = image->w;
