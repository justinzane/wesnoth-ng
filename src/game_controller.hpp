...
struct jump_to_campaign_info {
    public:
        jump_to_campaign_info(bool jump,
                              int difficulty,
...
class game_controller {
    public:
        ...
        SDL_Window* get_wes_win() { return wes_win_; }
        game_display& disp();
        bool init_video();
        bool init_language();
        bool init_joystick();
        ...
        void clear_loaded_game() {
            game::load_game_exception::game.clear();
        }
        bool load_game();
        void set_tutorial();
        ...
        enum RELOAD_GAME_DATA {
            RELOAD_DATA, NO_RELOAD_DATA
        };
    ...
    private:
        ...
        // Private Variables ------------------------------------------------------------------
        SDL_Window* wes_win_; /**< pointer to the SDL2 Window */
