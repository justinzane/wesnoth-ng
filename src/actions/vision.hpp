...
class shroud_clearer: public boost::noncopyable {
    public:
        ...
        void cache_units(const team * new_team = NULL) {
            calculate_jamming(new_team);
        }
        ...
        bool clear_unit(const map_location &view_loc,
                        ...
                        size_t * enemy_count = NULL,
                        size_t * friend_count = NULL,
    ...
    private:
        ...
        inline void record_sighting(const unit & seen,
