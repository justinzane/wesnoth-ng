...
libwesnoth_core_sources.extend(env.Object("network_worker.cpp",
                                          EXTRA_DEFINE = env['raw_sockets'] and
                                          "NETWORK_USE_RAW_SOCKETS" or None))
...
libwesnoth_sources = Split("""
    whiteboard/arrow.cpp
    pathfind/astarsearch.cpp
    builder.cpp
    animated_game.cpp
    gui/clipboard.cpp
    gui/construct_dialog.cpp
    gui/cursor.cpp
    gui/desktop_util.cpp
    gui/display.cpp
    gui/dialogs.cpp
    gui/drawing_buffer_key.cpp
    gui/filechooser.cpp
    gui/floating_textbox.cpp
    gui/game_display.cpp
    gui/halo.cpp
    gui/portrait.cpp
    gui/sdl_utils.cpp
    gui/show_dialog.cpp
    gui/sound.cpp
    gui/sound_music_track.cpp
    gui/theme.cpp
    gui/tooltips.cpp
    gui/video.cpp
    events.cpp
...
libwesnoth_sources.extend([
    client_env.Object("gui/font.cpp",
                      EXTRA_DEFINE = client_env['fribidi'] and "HAVE_FRIBIDI" or None),
    ])
...
if env["PLATFORM"] == "win32":
    wesnoth_sources.append("gui/windows_tray_notification.cpp")
