		...
		network::connection from, std::deque<config>& backlog, bool skip_replay)
{
	...
	{
		resources::screen->add_chat_message(time(nullptr), msg["sender"], msg["side"],
	...
	{
		resources::screen->add_chat_message(time(nullptr), "whisper: " + msg["sender"].str(), 0,
