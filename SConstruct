...
opts.AddVariables(
    ...
    ('extra_flags_base',
        ...
        "-march=core-avx-i -static-libgcc"),
    ('extra_flags_release',
        'Extra compiler and linker flags to use for release builds', 
        "-O2"),
    ('extra_flags_debug',
    ...
    ('extra_flags_profile',
        ...
        """-O2 -fprofile-generate -lgcov"""),
    ('extra_flags_pgo',
        'Extra compiler and linker flags to use for profile guided opt. builds', 
        """-O2 -freorder-functions -fprofile-use -fprofile-correction -fbranch-probabilities -flto -fuse-linker-plugin"""),
    PathVariable('bindir',
